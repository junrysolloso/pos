...
<div class="row">
  <div class="col-md-12 grid-margin">
    <div class="card shadow-sm">
      <div class="card-body">
        <form action="<?php echo base_url(); ?>temp/edit" method="post" class="dataForm">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="order_date" value="<?php echo $row->tmp_date; ?>" class="form-control" id="order_date" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="yyyy-mm-dd" disabled required />
                    <input type="hidden" name="tmp_id"  value="<?php echo $row->id; ?>" >
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="prod_name" value="<?php echo ucfirst( $row->item_name ) .'  '. $row->item_description; ?>" class="form-control" id="prod_name" disabled required />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="prod_code" value="<?php echo $row->tmp_barcode; ?>" class="form-control" id="prod_code" disabled />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="prod_category" value="<?php echo $row->category_name; ?>" class="form-control" id="prod_category" disabled />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" name="prod_quantity" value="<?php echo $row->tmp_quantity; ?>" class="form-control" id="prod_quantity" required />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" value="<?php echo $row->tmp_price; ?>"  u-equiv="<?php echo $row->equivalent; ?>" step="0.01" name="unit_price" class="form-control" id="unit_price" required 
                      onkeyup="
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="expiry_date" value="<?php echo $row->tmp_expiry; ?>" class="form-control" id="expiry_date" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="yyyy-mm-dd" required />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="prod_srp" value="<?php echo $row->tmp_srp; ?>" class="form-control" id="prod_srp" required />
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline mdi-18px"></i>
                      </span>
