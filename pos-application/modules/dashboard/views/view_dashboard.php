              ...
              <div class="row">
                ...
                <div class="col-md-3 pl-4 pr-4 mt-4 mt-md-0">
                  <div class="wrapper border-bottom mb-5 pb-5">
                    ...
                    <canvas id="network-bar-chart-1" height="41" width="180" class="chartjs-render-monitor"
                      style="display: block; height: 46px; width: 201px;"></canvas>
                  </div>
                  <div class="wrapper">
                    <div class="chartjs-size-monitor">
                      <div class="chartjs-size-monitor-expand">
                    ...
                    <div class="d-flex justify-content-between">
                      <h4 class="font-weight-semibold">22.5%</h4>
                    ...
                    <canvas id="network-bar-chart-2" height="41" width="180" class="chartjs-render-monitor"
                      style="display: block; height: 46px; width: 201px;"></canvas>
                  </div>
