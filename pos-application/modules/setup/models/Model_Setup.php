...
class Model_Setup extends MY_Model
{
  ...
  public function clean_dummy( $table ) {
    ...
    switch ( $table ) {
      case 'unit convert':
        if( $this->db->truncate( 'tbl_unitconvert' ) ) { return true; }
        break;
      case 'unit':
        if( $this->db->truncate( 'tbl_unit' ) ) { return true; }
        break;
      case 'sub category':
        if( $this->db->truncate( 'tbl_subcategory' ) ) { return true; }
        break;
      case 'sales info':
        if( $this->db->truncate( 'tbl_salesinfo' ) ) { return true; }
        break;
      case 'sales':
        if( $this->db->truncate( 'tbl_sales' ) ) { return true; }
        break;
      case 'orders':
        if( $this->db->truncate( 'tbl_orders' ) ) { return true; }
        break;
      case 'order inventory':
        if( $this->db->truncate( 'tbl_orderinventory' ) ) { return true; }
        break;
      case 'order details':
        if( $this->db->truncate( 'tbl_orderdetails' ) ) { return true; }
        break;
      case 'items':
        if( $this->db->truncate( 'tbl_items' ) ) { return true; }
        break;
      case 'inventory':
        if( $this->db->truncate( 'tbl_inventory' ) ) { return true; }
        break;
      case 'category':
        if( $this->db->truncate( 'tbl_category' ) ) { return true; }
        break;
      case 'log':
        if( $this->db->truncate( 'tbl_log' ) ) { return true; }
        break;
      case 'all':
